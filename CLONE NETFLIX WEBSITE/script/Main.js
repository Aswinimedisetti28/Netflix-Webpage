...
fetch(requests.fetchDramaMovies)
  ...
  // Select all language boxes
const languageBoxes = document.querySelectorAll('.language-box');

// Add event listener to each language box
languageBoxes.forEach(box => {
  box.addEventListener('click', () => {
    alert(`You selected ${box.innerText}`);
    // You can also store the selected language in localStorage or update the UI
  });
});
